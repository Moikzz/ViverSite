...
export interface ApiCarouselCarousel extends Schema.SingleType {
  ...
  attributes: {
    Imagem: Attribute.Component<'media.imagem', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiDocumentoDocumento extends Schema.CollectionType {
  ...
  attributes: {
    ...
    UIDDocumento: Attribute.UID<'api::documento.documento', 'nome'> &
      Attribute.Required;
    Arquivo: Attribute.Media & Attribute.Required;
    tipo: Attribute.Component<'documento.tipo'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiFooterFooter extends Schema.SingleType {
  ...
  attributes: {
    ConjuntoLink: Attribute.Component<'pack.secao-de-link', true>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiPostPost extends Schema.CollectionType {
  ...
  attributes: {
    UID: Attribute.UID<'api::post.post', 'Titulo'> & Attribute.Required;
    Titulo: Attribute.String &
      Attribute.Required &
      Attribute.DefaultTo<'Escreva aqui o T\u00EDtulo da Postagem'>;
    tags: Attribute.Relation<'api::post.post', 'manyToMany', 'api::tag.tag'>;
    BlocodeTexto: Attribute.Component<'post.texto', true> & Attribute.Required;
    categoria: Attribute.Component<'post.categoria'> & Attribute.Required;
    Data: Attribute.Date & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiTagTag extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::tag.tag', 'Nome'> & Attribute.Required;
